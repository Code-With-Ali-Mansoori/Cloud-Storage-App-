...
export interface SharedByMeFileListProps {
  filteredFiles?: any[];
  searchTerm: string;
}

const FileList: React.FC<SharedByMeFileListProps> = ({ filteredFiles, searchTerm }) => {
  ...
  const handleManagePermissions = (file: any) => {
              ...
              {file.sharedWith.length > 0 && (
                <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-100">
                  ...
                  <div className="block sm:hidden space-y-2">
                    {file.sharedWith.slice(0, 2).map((share: any) => (
                      <div
                        key={share.user._id}
                  ...
                  <div className="hidden sm:flex sm:flex-wrap gap-3">
                    {file.sharedWith.slice(0, 3).map((share: any) => (
                      <div
                        key={share.user._id}
