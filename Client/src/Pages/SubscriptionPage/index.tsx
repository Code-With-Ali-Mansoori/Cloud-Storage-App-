...
import ActiveSubscription, { SubscriptionDetailsProps, UserUsageProps } from "./ActiveSubscription";
import Plans from "./Plans";
import RenewalFailed from "./RenewalFailed";
import Loader from "../../components/Loader";

interface SubscriptionPageState {
  subscription: SubscriptionDetailsProps | null;
  usage: UserUsageProps | null;
...
export default function SubscriptionPage() {
  ...
  if (state.hasActivePlan && state.subscription && state.usage) {
    return (
      <ActiveSubscription
