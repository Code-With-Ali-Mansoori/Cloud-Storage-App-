...
export const monthlyPlans: PlanItem[] = [
  {
    id: {
...
export const yearlyPlans: PlanItem[] = [
  {
    id: {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mb-12">
            {currentPlans.map((plan) => {
              ...
              const planIdValue = plan.id[modeKey];
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6">
                          ...
                          {isYearly && (
                            <div>
                              ...
                              <p className="text-xs text-green-600 font-medium mt-0.5">
                                Save ₹{(plan.originalMonthly || 0) * 12 - plan.price} per
                                year
                              </p>
                            </div>
                          )}
                    ...
                    {/* CTA Button */}
                    <button
                      onClick={() => handleSubmit(planIdValue)}
                      disabled={
                        loadingPlanId === planIdValue || isCurrentPlan
                      }
