...
const UserTableRow: React.FC<UserTableRowProps> = ({
  ...
  const usedStorage = user.storage?.usedStorage || 0;
  const totalStorage = user.storage?.totalStorage || 1;
  const usageRatio = usedStorage / totalStorage;
