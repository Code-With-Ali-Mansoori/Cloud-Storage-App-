...
export interface DeleteModalProps {
  ...
  role: string;
  onClose: () => void;
  onDelete: (deleteType: "soft" | "hard" | string, userId: string) => void;
}

const DeleteModal: React.FC<DeleteModalProps> = ({ isOpen, user, role, onClose, onDelete }) => {
  if (!isOpen || !user) return null;

  const handleDeleteChoice = (deleteType: "soft" | "hard" | string) => {
    onDelete(deleteType, user.id || user._id);
    onClose();
  };
