...
import { PasswordData } from "../../hooks/useUserSettings";
...
export interface PasswordSettingsProps {
  ...
  setHasManualPassword: React.Dispatch<React.SetStateAction<boolean>>;
}
...
const PasswordSettings: React.FC<PasswordSettingsProps> = ({
  ...
  const handlePasswordAction = async () => {
    ...
    if (res.success) {
      ...
      showModal("Error", res.message || "An error occurred", "error");
    }
  };
