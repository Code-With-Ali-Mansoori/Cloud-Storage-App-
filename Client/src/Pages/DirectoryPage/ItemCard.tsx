...
export interface ItemCardProps {
  ...
  setCurrentFile: (file: DirectoryItem) => void;
  onDetailsOpen: (item: DirectoryItem) => void;
}
...
const ItemCard: React.FC<ItemCardProps> = ({
  ...
  const [renameModalData, setRenameModalData] = useState<{ open: boolean; item: DirectoryItem | null }>({
    open: false,
    item: null,
  });
