 ...
 */
const sanitizeFilenameASCII = (filename: string): string => {
...
export const getCloudFrontSignedURL = ({ File, Action, expiresIn = 3600 }: { File: any; Action?: string; expiresIn?: number }): string => {
  ...
  return getSignedUrl({
    url,
    keyPairId: keyPairId || "",
    dateLessThan: dateLessThan as any,
