...
The application stores files using **AWS S3** for secure file storage.
...
5. Run setup script (for database and required folders):

   ```bash
   npm run setup
   ```

6. Ensure Redis is running (via WSL or local setup).
